...
class BookServiceTest @Autowired constructor(
    ...
    fun loanBookTest(){
        ...
        val savedUser = userRepository.save(User("최준영", null))
        val request = BookLoanRequest("최준영", "이상한 나라의 엘리스")
    ...
    @Test
    @DisplayName("책이 이미 대출되어있으면 신규 대출 실패")
    ...
    fun returnBookTest(){
        ...
        val savedUser = userRepository.save(User("최준영", null))
        userLoanHistoryRepository.save(UserLoanHistory.fixture(savedUser,"이상한 나라의 엘리스"))
        val request = BookReturnRequest("최준영", "이상한 나라의 엘리스")
